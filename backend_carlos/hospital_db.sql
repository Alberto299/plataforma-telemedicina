...
CREATE TABLE `diagnosticos` (
  ...
  `resultado_ia` varchar(50) DEFAULT NULL,
  `confianza` float DEFAULT NULL,
  `ciclos_detectados` int DEFAULT NULL,
  `fecha_analisis` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `paciente_id` (`paciente_id`),
  CONSTRAINT `diagnosticos_ibfk_1` FOREIGN KEY (`paciente_id`) REFERENCES `pacientes` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-11-23 22:02:07
